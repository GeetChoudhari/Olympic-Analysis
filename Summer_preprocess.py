...
def summer():
    ...
    with header:
        st.markdown(
            "<h1 style='text-align: center; color:yellow ;'>Summer Olympics </h1>", unsafe_allow_html=True)
    ...
    with info:
        ...
        if user == "Medal Tally":
            ...
            if selected_year == 'Overall' and selected_country == 'Overall':
                st.title("Overall Medal Tally from 1896-2016")
            if selected_year != 'Overall' and selected_country == 'Overall':
        ...
        if user == "Overall Analysis":
            ...
            st.markdown(
                "<h2 style='text-align: center; color:yellow ;'>Overall Analysis (1896-2016) </h2>", unsafe_allow_html=True)
